...
- de limiter l'exposition directe des machines Windows ;
- de contrôler les accès administratifs ;
- d'améliorer la traçabilité des connexions.

## Résultat

Les postes et serveurs Windows sont désormais accessibles depuis l'interface Guacamole, permettant une administration centralisée et sécurisée de l'environnement.